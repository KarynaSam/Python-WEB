...
class SortDirectory:
    ...
    def copy_files(self, start_path: Path):
            ...
            for file in files:
                ...
                if ext in self.EXTENSIONS["archives"]:
                    ...
                    for folder_name, extensions in self.EXTENSIONS.items():
                        if ext in extensions:
                            ...
                            try:
                                ...
                                shutil.move(os.path.join(current_dir, file), start_path / folder_name / file)
                    ...
                    if not found_folder:
                        ...
                        shutil.move(os.path.join(current_dir, file), start_path / "others" / file)
